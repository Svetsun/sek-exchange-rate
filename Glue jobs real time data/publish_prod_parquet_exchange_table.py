...
SOURCE_PARQUET_TABLE_NAME = 'currency_exchange_table_parquet_1'
NEW_PROD_PARQUET_TABLE_NAME = 'currency_exchange_table_parquet_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://parquet-exchange-table-prod-bucket'
