...
SOURCE_PARQUET_TABLE_NAME = 'currency_exchange_table_parquet_last_30d'
NEW_PROD_PARQUET_TABLE_NAME = 'currency_exchange_table_parquet_prod_last_30d'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://parquet-exchange-table-prod-bucket-last-30d'
